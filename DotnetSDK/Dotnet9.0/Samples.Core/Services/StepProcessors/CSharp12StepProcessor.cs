...
namespace PreEmptive.Dotfuscator.Samples.Core.Services.StepProcessors
{
	...
	internal class CSharp12StepProcessor : StepProcessorBase
	{
		...
		public string? result = "\e[32m C# 12: Success\e[0m"; // green text in terminal
...
#pragma warning disable TS0001
			ExperimenalAttributesMethod(); // Experimental Attributes feature will give a warning or error if used without pragma
