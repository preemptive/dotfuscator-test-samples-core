...
namespace PreEmptive.Dotfuscator.Helper.ParallelExecution
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string projectPath = Path.GetFullPath(Path.Combine(current, @"..\..\..\..\PreEmptive.Dotfuscator.TestSamples.ConsoleApp\"));
            ...
            string obfusctedAssemblyDirectory = Path.Combine(projectPath, "bin", "Release", "net6.0");
