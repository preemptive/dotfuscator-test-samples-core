...
using System.IO;
namespace PreEmptive.Dotfuscator.Helper.ParallelExecution
{
	...
	public Program()
	{
        ...
        static void Main(string[] args)
        {
            ...
            string projectPath = "../PreEmptive.Dotfuscator.TestSamples.ConsoleApp/";
            string dotfuscatorHome = Environment.GetEnvironmentVariable("DOTFUSCATOR_HOME");

            exePath = dotfuscatorHome + "/dotfuscator";
            ...
            Console.WriteLine("Argument =  {0}", arguments);
            Console.WriteLine("obfusctedAssemblyDirectory =  {0}", obfusctedAssemblyDirectory);
            Console.WriteLine("Number of Dotf instance =  {0}\n\n", noOfDotInstances);
        ...
        private static void Process_ErrorDataReceived(object sender, DataReceivedEventArgs e)
        {
            if (e != null && e.Data != null)
            {
                ...
                Console.WriteLine("Process {0}: {1} liju", processId, e.Data.ToString());
            }
        }
